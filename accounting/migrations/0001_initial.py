# Generated by Django 3.1.4 on 2024-08-27 21:53
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('name', models.CharField(max_length=100, verbose_name='账户类型名')),
                ('amount', models.DecimalField(decimal_places=2, max_digits=8, verbose_name='账户余额')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(max_length=100, verbose_name='货币名称')),
                ('icon', models.CharField(max_length=100, verbose_name='货币图标')),
            ],
            options={
                'ordering': ['id'],
            },
